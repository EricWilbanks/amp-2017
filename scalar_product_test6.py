...
def main():
	...
	def con5(x):
		return x[1] * (x[3]**1) - x[1] * (x[3]**2) + x[2] * (x[4]**7) - x[2] * (x[4]**5) - c

	def con6(x):
		return x[1] * (x[3]**7) - x[1] * (x[3]**2) + x[2] * (x[4]**1) - x[2] * (x[4]**5) - c

	def con7(x):
		return x[1] * (x[3]**3) - x[1] * (x[3]**2) + x[2] * (x[4]**5) - x[2] * (x[4]**5) - c

	def con8(x):
		return -x[0] + x[1] * (x[3]**4) - x[1] * (x[3]**2) + x[2] * (x[4]**4) - x[2] * (x[4]**5) - c
